...
class PostDetail extends Component {
    ...
    componentDidMount() {
        fetch('http://localhost:52013/api/Post/' + this.props.match.params.id)
    ...
    removeComment(commentId, e) {
        fetch('http://localhost:52013/api/Post?commentId=' + commentId, { method: 'delete' })
            .then((Response) => Response.json())
            .then((findresponse) => {
    ...
    handleSubmit(event) {
        ...
        var loads = 1;
        fetch('http://localhost:52013/api/values', {
            method: 'post',
            headers: {
